...
const cardData = [
    {
        ...
        <div class=" grid lg:grid-cols-12 lge:grid-cols-12 sm:grid-cols-1">
          ...
          <div class=" lg:col-span-8 lge:col-span-8 md:col-span-10 mdsm:col-span-10 sm:grid-cols-12">
            <div class=" grid lg:grid-cols-3 lge:grid-cols-3 md:grid-cols-2 mdsm:grid-cols-2 sm:grid-cols-1 gap-10 sm:px-2 sm:gap-4">
              <div class="  bg-[#ed913230] rounded-2xl p-4 ">
                ...
                <div class=" block">
                  <div class="  milonga-font tracking-wide pt-2 font-semibold text-3xl text-[#ed9132] text-center ">
                    Room
                  </div>
                </div>
              </div>
              ...
              <div class="  bg-[#ed913230] rounded-2xl p-4 ">
                ...
                <div class=" block">
                  <div class="  milonga-font tracking-wide font-semibold text-3xl text-[#ed9132] text-center ">
                    Food
                  </div>
                </div>
              </div>
